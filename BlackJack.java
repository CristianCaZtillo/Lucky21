...
public class BlackJack {
        ...
        while(!command.equalsIgnoreCase("q")){  
            ...
            switch (command){
                ...
                case "s":
                    ...
                    if (dealerCount == 21 || (dealerCount > playerCount && dealerCount <= 21)){
                        System.out.println("( Dealer WINS )");
                    }
                    else if (playerCount == 21 || playerCount > dealerCount || dealerCount > 21){
    ...
    public String playerHit(){
        ...
        if (outputCard.contains("Ace")){
            System.out.println("You Drew An Ace! [1] or [11]?");
            System.out.print("Input: ");
            String aceChoice = input.nextLine().trim();
            if (aceChoice.equals("11")){
                playerCount += 11;
            }
            else{
                playerCount += 1;
        ...
        return "Your Card: ( " + deck.returnPlayerCards() + " )";
    }
    ...
    public void split(){
        ...
        int deductValue;
        if (splitCard.startsWith("Ace")){
            deductValue = (playerCount - 11 >= 0) ? 11 : 1;
        } else {
    ...
    public String splitHit(){
        ...
        if (card.startsWith("Ace")){
            System.out.println("Ace drawn for split hand! [1] or [11]?");
            System.out.print("Input: ");
            String choice = input.nextLine().trim();
            splitCount += choice.equals("11") ? 11 : 1;
        } else {
